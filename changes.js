...
let fare = 210 ;
let source = "NALLA-SOPARA";
let source_hindi = "नालासोपारा";
let destination = "DADAR";
let destination_hindi = "दादर ";
let via = "------";
let adult = 1;
let child = 0;
let train = "AC EMU";
let train_hindi = "ए.सी ईएमयू";
let train_hindi2 = "ए.सी ईएमयू";
let date = "11/11/2024";
let time = "12:30";
